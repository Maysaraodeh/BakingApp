...
import static com.masotech.bakingapp.BakingService.FROM_ACTIVITY_INGREDIENTS_LIST;
...
//        }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals("android.appwidget.action.APPWIDGET_UPDATE2")) {
            ...
            BakingWidgetProvider.updateAppWidget(context, appWidgetManager, appWidgetIds);
